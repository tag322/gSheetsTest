...
export default {
	...
	methods: {
		...
		async deleteItem(emitData) {
			...
			// await axios.post('https://sheets.googleapis.com/v4/spreadsheets/1BqR1iknD9yGx8jP5jqX_CuUlbPGiuB299oOs5hOJgVI/values/A10:ZZ10:clear?key=AIzaSyCJQd8TMh2ytxeoQxZpeZspwoODh2kIEcw', {
